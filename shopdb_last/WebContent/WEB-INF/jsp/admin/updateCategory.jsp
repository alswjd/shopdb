  ...
  <br>
	<form method="post" action="${pageContext.request.contextPath}/admin/UpdateCategory">
		<table class="table table-hover">
			<tr>
				<td>category_id:</td>
				<td><input type="text" name="categoryId" value="${ca.categoryId}" readonly="readonly"></td>
			</tr>
			<tr>
				<td>category_name:</td> 
				<td><input type="text" name="categoryName" value="${ca.categoryName}"></td>
			</tr>
		</table>
		<div>
